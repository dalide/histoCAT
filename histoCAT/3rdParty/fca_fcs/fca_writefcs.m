...
if (numel(num2str(HeaderStop)) > 4)
    %uiwait(msgbox('Unfortunately fcs file format supports up to 9,999 total fcs header characters, you either have to many channels or your channel names are too long|n','error'));               
    failedfcs = 1;
